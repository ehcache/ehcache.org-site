...
Implement the [cache-as-sor](/documentation/get-started/concepts#cache-as-sor) pattern by using a [BlockingCache or SelfPopulatingCache](/documentation/apis/constructs) included with Ehcache.
