...
See [Terracotta Distributed Ehcache WAN Replication](/documentation/wan-replication) to learn more about the Terracotta version of this solution.
...
* Available as a fully featured solution, [Terracotta Distributed Ehcache WAN Replication](/documentation/wan-replication), which includes persistence, delivery guaranty, conflict resolution, and more.
