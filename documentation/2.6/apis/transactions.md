...
price in performance to get that extra safety. This is the only mode that can work with [nonstop caches](/documentation/2.6/configuration/non-stop-cache) (beginning with Ehcache 2.4.1).
