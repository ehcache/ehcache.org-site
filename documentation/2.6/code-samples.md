...
All usages of Ehcache start with the creation of a CacheManager. See [Key Classes and Methods](/documentation/2.6/get-started/key-classes-methods#cm-creation) for details on how to create CacheManagers.
...
Replication architectures such as RMI, JMS, or JGroups are not supported, as there is no locking in those architectures.
...
### Terracotta Example
See the fully worked examples in [Terracotta Clustering](/documentation/2.6/get-started/about-distributed-cache#code-samples).
...
### JCache Examples
See the examples in [JCache](/documentation/2.6/integrations/jsr107).

### Cache Server Examples
See the examples in [Cache Server](/documentation/2.6/modules/cache-server).
