...
If you choose the data expiration method, you can read more about the cache configuration settings at [cache eviction algorithms](/documentation/2.6/apis/cache-eviction-algorithms) and [timeToIdle and timeToLive configuration settings](/documentation/2.6/configuration/configuration).
