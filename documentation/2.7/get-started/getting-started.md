...
More information on configuration can be found here: [copyOnRead and copyOnWrite cache configuration](/documentation/2.7/configuration/configuration#copyonread-and-copyonwrite-cache-configuration).
