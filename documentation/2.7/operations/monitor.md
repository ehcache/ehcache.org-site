...
**NOTE:** The [Terracotta Management Console](http://terracotta.org/documentation/2.7/tms) is now available for standalone enterprise Ehcache and replaces Ehcache Monitor for monitoring, management, and administration. For download instructions, contact pm@terracotta.org. 
