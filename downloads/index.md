...
> [Ehcache 3.2 latest](https://github.com/ehcache/ehcache3/releases/download/v3.2.1/ehcache-3.2.1.jar) .jar

#### Ehcache 3 with clustering support

> [Ehcache 3.2 (with clustering) kit](https://github.com/ehcache/ehcache3/releases/download/v3.2.1/ehcache-clustered-3.2.1-kit.zip) .zip
