...
> [Ehcache 3.4 latest](https://github.com/ehcache/ehcache3/releases/download/v3.4.0/ehcache-3.4.0.jar) .jar

#### Ehcache 3 with clustering support

> [Ehcache 3.4 (with clustering) kit](https://github.com/ehcache/ehcache3/releases/download/v3.4.0/ehcache-clustered-3.4.0-kit.zip) .zip
