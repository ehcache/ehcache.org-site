...
> [Ehcache 3.5 latest](https://github.com/ehcache/ehcache3/releases/download/v3.5.2/ehcache-3.5.2.jar) .jar

#### Ehcache 3 with clustering support

> [Ehcache 3.5 (with clustering) kit](https://github.com/ehcache/ehcache3/releases/download/v3.5.2/ehcache-clustered-3.5.2-kit.zip) .zip
...
> [Ehcache 2.10.4](http://d2zwv9pap9ylyd.cloudfront.net/ehcache-2.10.5-distribution.tar.gz)  .tar.gz
