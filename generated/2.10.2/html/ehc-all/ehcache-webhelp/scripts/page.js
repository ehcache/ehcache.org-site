    ...
    if (Page.dispatch === undefined) {
        Page.dispatch = {
            ...
            'page_socialize': function (param_data) {
                var twitter_span, twitter_iframe, facebook_span, facebook_iframe, linkedin_span, linkedin_script, google_span, google_script, first_script, disqus_div, disqus_script;
                ...
                if ((!Page.socialized) && (Page.window.document.location.protocol !== 'file:')) {
                    ...
                    if (twitter_span !== null) {
                        ...
                        if (twitter_iframe !== null) {
                            twitter_iframe.contentWindow.location.replace('http://platform.twitter.com/widgets/tweet_button.html?lang=en&count=horizontal&url=' + encodeURIComponent(Page.window.document.location.href));
                        }
                    }
                    ...
                    if (facebook_span !== null) {
                        ...
                        if (facebook_iframe !== null) {
                            facebook_iframe.contentWindow.location.replace('http://www.facebook.com/plugins/like.php?layout=button_count&show_faces=false&action=like&colorscheme=light&width=90&height=20&href=' + encodeURIComponent(Page.window.document.location.href));
                        }
                    }
